...
import { mockEnhancedIssue } from "../../../../testing";
...
describe("IssueItem", () => {
  ...
  test("render", async () => {
    const { findByText, container } = renderIssueItem({
      issue: mockEnhancedIssue as never,
    });
    ...
    expect(await findByText(/MAIN-7/i)).toBeInTheDocument();
